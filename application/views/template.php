				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown <?php echo ($this->uri->segment(1)=='presences'||$this->uri->segment(1)=='attendance') ? 'active' : ''; ?>">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<!-- <li><a href="<?php echo base_url().'presences/input_absen_masuk'; ?>">Absen Masuk</a></li> -->
							<li><a href="<?php echo base_url().'presences/input_absensi'; ?>">Absensi</a></li>
							...
							<li class="divider"></li>
							<li><a href="<?php echo base_url().'presences/list_rekap'; ?>">Rekap Absen</a></li>
							<?php
							}
							?>
						</ul>
